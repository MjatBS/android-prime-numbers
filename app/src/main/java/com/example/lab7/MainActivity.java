...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchPrimesSeries = this.findViewById(R.id.searchPrimesSeries);
        showPrimesSeriesButton = this.findViewById(R.id.showPrimesSeriesButton);
        searchLayout = this.findViewById(R.id.searchInputLayout);
